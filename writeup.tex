...
\placeholder{Profile xl model on 2 GPUs with FSDP and report expected peak memory savings with derivation.}

\subquestion{(b) Weight all-gather profiling}
\placeholder{Profile xl model on 2 GPUs with FSDP using Nsight Systems. Report whether all-gather finishes before each layer's compute. Include Nsight screenshots.}
...
\placeholder{Report the best wall-clock median training step time in milliseconds from the leaderboard submission.}
